...
N 1780 -650 1860 -650 {lab=vdcbias}
N 1860 -560 1860 -550 {lab=vx}
N 1010 -390 1010 -330 {lab=vm2}
N 1780 -490 1780 -410 {lab=vx}
N 1700 -490 1700 -470 {lab=vx}
N 1700 -470 1780 -470 {lab=vx}
N 1860 -550 1860 -470 {lab=vx}
N 1000 -690 1030 -690 {lab=g_csc}
N 1640 -250 1640 -220 {lab=GND}
N 1300 -640 1300 -610 {lab=GND}
N 730 -370 730 -340 {lab=GND}
N 950 -500 990 -500 {lab=GND}
N 1760 -620 1760 -600 {lab=GND}
N 1780 -730 1780 -670 {lab=vdcbias}
N 970 -740 970 -710 {lab=GND}
N 1880 -510 1880 -480 {lab=GND}
N 750 -690 840 -690 {lab=s}
...
C {lab_pin.sym} 680 -320 0 0 {name=p20 sig_type=std_logic lab=vbias_cg}
C {lab_pin.sym} 790 -320 2 0 {name=p21 sig_type=std_logic lab=g_cg}
C {lab_pin.sym} 780 -170 2 0 {name=p19 sig_type=std_logic lab=GND}
...
C {lab_pin.sym} 650 -170 0 0 {name=p15 sig_type=std_logic lab=g_cg}
C {lab_pin.sym} 1780 -70 3 0 {name=p16 sig_type=std_logic lab=GND}
C {lab_pin.sym} 1720 -270 0 0 {name=p18 sig_type=std_logic lab=g_cs}
C {lab_pin.sym} 1590 -200 0 0 {name=p23 sig_type=std_logic lab=vbias_cs}
...
device=resistor
m=1}
C {symbols/nfet_06v0.sym} 1760 -380 0 0 {name=M4
L=0.6u
W=35u
nf=10
m=4
...
C {lab_pin.sym} 1720 -380 0 0 {name=p47 sig_type=std_logic lab=vbias_cas}
C {lab_pin.sym} 1800 -380 2 0 {name=p48 sig_type=std_logic lab=GND}
...
C {res.sym} 1750 -130 0 0 {name=RS_EQ
value=0.05
footprint=1206
device=resistor
m=1
}
C {lab_pin.sym} 1800 -270 2 0 {name=p55 sig_type=std_logic lab=GND}
C {symbols/nfet_03v3.sym} 1760 -270 0 0 {name=M1
L=0.28u
W=20u
nf=10
m=10
...
C {lab_pin.sym} 1440 -460 3 0 {name=p26 sig_type=std_logic lab=GND}
C {lab_pin.sym} 1380 -660 0 0 {name=p28 sig_type=std_logic lab=g_csc}
C {lab_pin.sym} 1250 -590 0 0 {name=p29 sig_type=std_logic lab=vbias_csc}
C {lab_pin.sym} 1360 -590 2 0 {name=p30 sig_type=std_logic lab=g_csc}
C {symbols/nfet_06v0.sym} 1420 -770 0 0 {name=M7
L=0.6u
W=35u
nf=10
m=2
...
C {lab_pin.sym} 1380 -770 0 0 {name=p32 sig_type=std_logic lab=vbias_casc}
C {lab_pin.sym} 1460 -770 2 0 {name=p33 sig_type=std_logic lab=GND}
C {res.sym} 1410 -520 0 0 {name=RS_EQ1
value=0.25
footprint=1206
device=resistor
m=1
}
C {lab_pin.sym} 1460 -660 2 0 {name=p34 sig_type=std_logic lab=GND}
C {symbols/nfet_03v3.sym} 1420 -660 0 0 {name=M9
L=0.28u
W=60u
nf=4
m=4
...
C {lab_pin.sym} 1780 -450 0 0 {name=p36 sig_type=std_logic lab=vx}
C {lab_pin.sym} 1510 -850 2 0 {name=p66 sig_type=std_logic lab=vx}
...
C {lab_pin.sym} 1030 -690 2 0 {name=p68 sig_type=std_logic lab=g_csc}
C {lab_pin.sym} 750 -690 0 0 {name=p69 sig_type=std_logic lab=s}
...
C {lab_pin.sym} 1780 -328.75 0 0 {name=p72 sig_type=std_logic lab=vm1}
...
C {ind.sym} 1700 -520 0 0 {name=LD2
m=1
value=5.6n
footprint=1206
device=inductor
}
C {res.sym} 1700 -600 0 0 {name=RLD2
value=14.08
footprint=1206
device=resistor
m=1
}
C {code_shown.sym} 1710 50 0 0 {name=s1 only_toplevel=false value="
...
C {symbols/ppolyf_u_1k.sym} 1640 -200 1 0 {name=R2
W=1u
L=48.35u
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {lab_pin.sym} 1640 -250 1 0 {name=p31 sig_type=std_logic lab=GND}
C {symbols/ppolyf_u_1k.sym} 1300 -590 1 0 {name=R3
W=1u
L=48.35u
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {lab_pin.sym} 1300 -640 1 0 {name=p70 sig_type=std_logic lab=GND}
C {symbols/ppolyf_u_1k.sym} 730 -320 1 0 {name=R1
W=1u
L=48.35u
model=ppolyf_u_1k
spiceprefix=X
m=1}
C {lab_pin.sym} 730 -370 1 0 {name=p3 sig_type=std_logic lab=GND}
C {symbols/ppolyf_u.sym} 1010 -500 0 0 {name=R4
W=8u
L=18.96u
model=ppolyf_u
spiceprefix=X
m=1}
C {lab_pin.sym} 950 -500 0 0 {name=p75 sig_type=std_logic lab=GND}
C {symbols/ppolyf_u.sym} 1780 -600 0 0 {name=R5
W=8u
L=40u
model=ppolyf_u
spiceprefix=X
m=1}
C {lab_pin.sym} 1760 -620 1 0 {name=p76 sig_type=std_logic lab=GND}
C {lab_pin.sym} 970 -740 1 0 {name=p77 sig_type=std_logic lab=GND}
...
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 440 -410 1 0 {name=C2
W=105u
L=105u
model=cap_mim_2f0_m4m5_noshield
spiceprefix=X
...
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 1800 -130 0 0 {name=C6
W=6.85336u
L=6.85336u
model=cap_mim_2f0_m4m5_noshield
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 1460 -520 0 0 {name=C7
W=33.0108u
L=33.0108u
model=cap_mim_2f0_m4m5_noshield
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 1860 -600 0 0 {name=C8
W=15.5u
L=15.5u
model=cap_mim_2f0_m4m5_noshield
spiceprefix=X
m=1}
C {symbols/cap_mim_2f0fF.sym} 710 -170 1 0 {name=C9
W=49.8865u
L=49.8865u
model=cap_mim_2f0_m4m5_noshield
spiceprefix=X
m=4}
C {symbols/cap_mim_2f0fF.sym} 870 -690 3 0 {name=C10
W=60.55u
L=60.55u
model=cap_mim_2f0_m4m5_noshield
spiceprefix=X
m=3}
C {symbols/npolyf_u.sym} 970 -690 1 0 {name=R8
W=2u
L=3.03u
model=npolyf_u
spiceprefix=X
